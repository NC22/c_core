...
uses
  ...
  Dialogs, StdCtrls, Filectrl, c_core, c_query;
...
begin
    ...
    Unit1.Form1.ListView1.Clear;

    Unit1.Form1.AddServer(Ip.Text, StrToInt(Port.Text));
    Unit1.Form1.RefThemAll;
end;

procedure TForm2.Button4Click(Sender: TObject);
begin
   Unit1.Form1.ServerListClean;
end;
